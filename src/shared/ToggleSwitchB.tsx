                ...
                >
                    <span
                        className={`${enabled ? 'translate-x-32' : 'translate-x-4'
                            } inline-block h-12 w-12 transform rounded-full bg-meat bg-center transition-transform duration-500 shadow-[inset_0_-2px_4px_rgba(0,0,0,0.6)]`}
                    />
